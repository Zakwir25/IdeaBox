    ...
    @push('css')
        ...
        <style>
            ...
            @media (max-width: 768px) {
                ...
                /* Mengatur ukuran chart pada mobile */
                #stackedBarChart,
                #bestPracticePieChart,
                #novaBarChart,
                #improvementPieChart {
                    min-height: 300px !important;
                }

                /* Mengatur layout kolom pada mobile */
                .col-md-7,
                .col-md-5,
                .col-md-3 {
                    width: 100%;
                ...
                /* Mengatur jarak antar card pada mobile */
                .card.mb-4 {
                    margin-bottom: 1rem !important;
                }

                /* Mengatur ukuran font pada mobile */
                .card-title {
                    font-size: 1rem;
                }
                        ...
                        stackedBarChart.updateOptions({
                            ...
                            series: Object.keys(data).map(department => {
                                return {
                                    ...
                                    data: data[
                                        department
                                        ], // Array of data for the department (12 values for 12 months)
                                };
                            })
                        });
                    })
